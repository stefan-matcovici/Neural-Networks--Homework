...
parser.add_argument('-b', '--batch_size', type=int, default=256, metavar='NUMBER',
...
if __name__ == '__main__':
    ...
    cbks = [TensorBoard(log_dir='logs/resnet_{:d}_{}/'.format(layers, args.dataset), histogram_freq=0),
            LearningRateScheduler(scheduler),
            ModelCheckpoint('model.h5', verbose=1, save_best_only=True, monitor='val_acc')
            ]
